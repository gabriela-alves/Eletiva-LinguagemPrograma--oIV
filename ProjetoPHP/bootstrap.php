...
$router->get('/painel',
        'Aluno\ProjetoPhp\Controller\PainelController::index');
...
$router->get('/produto/novo','Aluno\ProjetoPhp\Controller\ProdutosController::abrirFormularioInserirProdutos');
